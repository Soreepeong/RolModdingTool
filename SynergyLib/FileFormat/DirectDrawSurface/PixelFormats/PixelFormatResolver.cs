...
public static class PixelFormatResolver {
    ...
    static PixelFormatResolver() {
        ...
        DxgiFormatToPixelFormat =
            new Dictionary<AlphaType, IReadOnlyDictionary<DxgiFormat, IPixelFormat>> {
                {
                    AlphaType.None, new Dictionary<DxgiFormat, IPixelFormat> {
                        {
                        ...
                        {DxgiFormat.R32G32B32Uint, RgbaPixelFormat.NewRgb(32, 32, 32, 0, 0, ChannelType.Uint, AlphaType.None)},
                        {DxgiFormat.R32G32B32Sint, RgbaPixelFormat.NewRgb(32, 32, 32, 0, 0, ChannelType.Sint, AlphaType.None)},
                        {DxgiFormat.R32G32Float, RgbaPixelFormat.NewRg(32, 32, 0, 0, ChannelType.Float, AlphaType.None)},
                        ...
                        {DxgiFormat.R16G16Typeless, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Typeless, AlphaType.None)},
                        {DxgiFormat.R16G16Float, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Float, AlphaType.None)},
                        {DxgiFormat.R16G16Unorm, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Unorm, AlphaType.None)},
                        {DxgiFormat.R16G16Uint, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Uint, AlphaType.None)},
                        {DxgiFormat.R16G16Snorm, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Snorm, AlphaType.None)},
                        ...
                        {DxgiFormat.R24G8Typeless, RgbaPixelFormat.NewRg(24, 8, 0, 0, ChannelType.Typeless, AlphaType.None)},
                        {DxgiFormat.R8G8Typeless, RgbaPixelFormat.NewRg(8, 8, 0, 0, ChannelType.Typeless, AlphaType.None)},
                        ...
                        {DxgiFormat.B5G6R5Unorm, RgbaPixelFormat.NewBgr(5, 6, 5, 0, 0, ChannelType.Unorm, AlphaType.None)},
                    ...
                    AlphaType.Straight, new Dictionary<DxgiFormat, IPixelFormat> {
                        {DxgiFormat.R32G32B32A32Typeless, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Typeless)},
                        {DxgiFormat.R32G32B32A32Float, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Float)},
                        ...
                        {DxgiFormat.R16G16B16A16Typeless, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Typeless)},
                        {DxgiFormat.R16G16B16A16Float, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Float)},
                        ...
                        {DxgiFormat.R16G16B16A16Snorm, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Snorm)},
                        {DxgiFormat.R16G16B16A16Sint, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Sint)},
                        {DxgiFormat.R10G10B10A2Typeless, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Typeless)},
                        ...
                        {DxgiFormat.R8G8B8A8UnormSrgb, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.UnormSrgb)},
                        ...
                        {DxgiFormat.B8G8R8A8UnormSrgb, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.UnormSrgb)},
                    ...
                    AlphaType.Premultiplied, new Dictionary<DxgiFormat, IPixelFormat> {
                        {
                    ...
                    AlphaType.Custom, new Dictionary<DxgiFormat, IPixelFormat> {
                        {DxgiFormat.B8G8R8X8Unorm, RgbaPixelFormat.NewBgr(8, 8, 8, 8, 0, ChannelType.Unorm, AlphaType.Custom)}, {
    ...
    public static IPixelFormat GetPixelFormat(AlphaType alphaType, DxgiFormat dxgiFormat) =>
